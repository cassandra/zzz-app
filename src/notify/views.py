...
class EmailUnsubscribeView( View ):
    ...
    def get( self, request, *args, **kwargs ):
        ...
        # A pseudo-secure hash to prevent malicious unsubscribes. An attacker
        # needs to know the "seed" to hash the email properly. The motivation
        # is that a user should not have to login or do any complicated flow to
