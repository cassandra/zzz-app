...
class SvgIconItem:
    ...
    the base SVG. This file can be one or more SVG drawing
    ...
    icon. For entities with states, this should also use the css_class
    ...
    def transform_str(self):
        return (
            ...
            f'rotate( {self.rotate} {self.bounds_center_x} {self.bounds_center_y} )'
        )
...
class SvgItemPositionBounds:
    ...
    # placement policy, not per-instance data - both the position bounds
