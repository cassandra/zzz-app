...
# ZZZ - Single Command Installer
# Installs and runs ZZZ with minimal user interaction
# Requires: Docker
...
# Pull Docker image
pull_docker_image() {
    print_info "Pulling ZZZ Docker image..."
...
start_container() {
    print_info "Starting ZZZ container..."
...
show_success() {
    ...
    echo -e "${GREEN}================================${NC}"
    echo
    echo -e "${BLUE}🌐 Access your ZZZ system:${NC}"
